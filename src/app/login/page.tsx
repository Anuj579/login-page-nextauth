  ...
  return (
    <div className='flex flex-col justify-center items-center min-h-screen'>
      <div className='flex flex-col'>
        ...
        <button className='px-3 py-2 bg-blue-600 rounded-md w-max mx-auto font-medium -tracking-tighter hover:bg-blue-700 transition-all active:bg-blue-800 disabled:bg-blue-400 disabled:text-gray-300 disabled:cursor-not-allowed' disabled= {buttonDisabled} onClick={onSignup}>Login</button>
